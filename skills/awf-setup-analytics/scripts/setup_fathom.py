...
def main(argv: list[str]) -> int:
    ...
    with log.session(composer="awf-setup-analytics", target="landing", start=project_root):
        with log.invoke(skill="awf-setup-analytics", args={"domain": domain, "force": opts["force"]}):
            try:
